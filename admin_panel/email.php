...
<body>
  <div class="main">
      ...
      <div class="sidebar">
        ...
        <div class="menu">
          ...
          <div class="menu-container">
            ...
            <div class="item">
              <a href="email.php" id="email"><i class="fa-solid fa-envelope"></i> Email</a>
            </div>
    ...
    <div class="right_sec">
      ...
      <nav>
        <span class="page-head">Emails</span>
        <div class="user">
              ...
              if ($total != 0) {
                while ($row = mysqli_fetch_assoc($data)) {
                  ...
                  <div class='email-content'>
                    ...
                    <a class='btn btn-danger' href='./controllers/delete_email.php?id=" . $row["id"] . "'>Delete</a> 
                    </div>
                  </div>
