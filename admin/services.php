        ...
        <div class="mid">
          <div class="page_scroll">
            ...
            <div class="content-container">
                            ...
                            while ($row = mysqli_fetch_array($service_data)) {
                              echo "
                                <tr>
                                  ...
                                  <td><img width='50px' src='". $row['Service_icon'] . "' alt='Image Not found?'></td>
                                  <td>
                                    <div class='act-btn'>
                                      <a data-bs-toggle='modal' data-bs-target='#ServiceModal2{$row["service_id"]}' class='btn btn-primary'>Edit</a>
                                      <a style='margin-left: 10px;' class='btn btn-danger' href='delete_service.php?service_id=" . $row["service_id"] . "'>Delete</a>
                                    </div>
                                  </td>
                                </tr>
                              ";
                                ...
                                <div class='modal-dialog modal-lg'>
                                  <div class='modal-content'>
                                    <div class='modal-header'>
                                      <h1 class='modal-title fs-5' id='ModalLabel'>Update Service</h1>
              ...
              <!-- <a data-bs-toggle="modal" data-bs-target="#ServiceModal1" class="btn btn-primary">+ Add Service</a> -->

              <div class="modal fade" id="ServiceModal1" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h1 class="modal-title fs-5" id="ModalLabel">Add Service</h1>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      
                      <form method="POST" action="upload_service.php" enctype="multipart/form-data" >
                        <div class="mb-3">
                          <label>Service Name:</label>
