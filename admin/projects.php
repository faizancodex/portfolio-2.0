                    ...
                    if ($total != 0) {
                        while ($row = mysqli_fetch_array($data)) {
                            ...
                            <tr>
                                ...
                                <td><img width='80px' src='". $row['image_src']."'></td>
                                <td>
                                    <div class='act-btn'>
                                        <a data-bs-toggle='modal' data-bs-target='#ProjectModal{$row["id"]}' class='btn btn-primary'>Edit</a>
                                        <a style='margin-left: 10px;' class='btn btn-danger' href='delete_project.php?id=" . $row["id"] . "'>Delete</a>
                                    </div>
                                </td>
                            </tr>
                            ";
                                ...
                                <div class='modal-dialog modal-lg'>
                                    <div class='modal-content'>
                                        <div class='modal-header'>
                                            <h1 class='modal-title fs-5' id='ModalLabel'>Update Project</h1>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <form action="upload_project.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          <label>Description:</label>
                          <textarea maxlength="250" style="height: 110px;" name="description" class="form-input"></textarea>
                        </div>
                        <div class="mb-3">
                          <label>Add Link:</label>
