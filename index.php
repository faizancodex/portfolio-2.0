...
<body>
    ...
    <div>
        ...
        <header class="container">
            ...
            <a class="btn" href="#contact" onclick="redirectToContactForm(event)"><i class="fa-solid fa-phone"></i> contact</a>
        </header>
            ...
            <div class="container">
                <div class="row">
                    <div class="about-col-1">
                        ...
                        <img src="./admin/<?php echo $row['Profile_image']; ?>" alt="Profile Not Found?" >
                    ...
                    <div class="about-col-2">
                        <div>
                            ...
                            <p>I am a passionate software developer with skills in both frontend and backend technologies. I specialize in HTML/CSS, JavaScript, React.js, and Bootstrap for front-end development, as well as server-side technologies such as Node.js, Express.js, MySQL, Django, and PHP. I'm excited about taking on new projects and using my knowledge to create impactful solutions. I am always eager to learn new technologies. I'm here to turn your ideas into reality. Let's work together to build something awesome!
                            </p>
                        </div>
                        ...
                        <div class="tab-contents" id="Certifications">
                            <ul>
                                <li>Web Development offered by Coursera<br><a href="images/Certificate.pdf"
                                        download>View</a></li>
                        ...
                        <div class="tab-contents" id="Resume">
                            <ul>
                                <li><a class="btn" href="images/my-resume.pdf" download><i
        ...
        <div id="services">
            <div class="container">
                        ...
                        if ($service_total  != 0) {
                            while ($row = mysqli_fetch_array($service_data)) {
                                ...
                                <div class='service-item'>
                                    <img style='width: 50px;margin-bottom: 20px;' src='./admin/". $row['Service_icon'] ."' alt='Image not found?' >
                ...
                <!-- <img src="./admin/services_img/microchip-solid.svg" style="width: 70px" alt='Image not found?' > -->
                </div>
                    ...
                    <?php 
                        if ($project_total != 0) {
                            while ($row = mysqli_fetch_array($project_data)) {
                                echo "
                                <div class='work'>
                                    <img src='./admin/".$row['image_src']."' alt='image not found'>
                                    <div class='layer'>
            ...
            <div class="container">
                <div class="row contact_row">
                    <div class="contact-left">
                        ...
                        <a href="mailto:faizanwriteme@gmail.com" target="_blank" class="fas fa-paper-plane"><span>faizanwriteme@gmail.com</span></a>
                        <br>
                        <a href="https://wa.me/1187961267" target="_blank" class="fas fa-brands fa-whatsapp"><span>1187961267</span></a>
        ...
        <footer>
            <a href="admin/dashboard.php" target="_blank" class="fa-solid fa-gear"></a>
